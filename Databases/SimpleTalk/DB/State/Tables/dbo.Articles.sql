...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Table of Simple Talk articles' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Articles'
GO