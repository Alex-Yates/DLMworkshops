...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (1, 'Homepage_Welcome_Message', N'<h2 class="MinMargin">Welcome to SQLServerCentral.com</h2><h3 class="MinMargin">A Microsoft SQL Server community of {NumberOfUsers} DBAs,developers and SQL Server users</h3>', 1)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (2, 'Script_Disclaimer', N'<center><h1>SQLServerCentral.com  Script Library</h1></center><blockquote><small>  <u>Disclaimer</u>: SQLServerCentral.com hopes that the information in these pages is valuable to you. Your use of the information contained in these pages, however, is at your sole risk. All information on these pages is provided "as -is", without any warranty, whether express or implied, of its accuracy, completeness, fitness for a particular purpose, title or non-infringement, and none of the third-party products or information mentioned in the work are authored, recommended, supported or guaranteed by me. SQLServerCentral.com shall not be liable for any damages you may sustain by using this information, whether direct, indirect, special, incidental or consequential, even if it has been advised of the possibility of such damages.</small></blockquote>', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (5, 'Login_RememberMe_Explanation', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (9, 'Footer', N'Copyright &copy; 2002-{CurrentYear} Simple Talk Publishing. All Rights Reserved. <a href="http://www.sqlservercentral.com/About/Privacy/">Privacy Policy.</a> <A href="http://www.sqlservercentral.com/About/Terms">Terms of Use</a>', 1)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (11, 'QotD_Intro', N'<p>We''d really appreciate you trying your best to get this right.</p><p>Please remember that the questions are for fun and to help you learn more about SQL Server. They are not intended as preparation for exams or certification.</p>', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (13, 'Contributions_Home_Intro', N'Write content for us. Please see the <a href="/About/WriteForUs">guide to writing for www.sqlservercentral.com</a> for details on what we''re looking for.', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (14, 'Contributions_Center_Link', N'If you would like to contribute an article, script, or suggest a Question of the Day, please visit the <a href="/Contributions/Home">Contribution Center</a>.', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (16, 'Registration_Page_Above', N'<!-- -->', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (17, 'Registration_Page_Below', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (18, 'Content_RightColumn_Advert', N'<!-- -->', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (19, 'Banner_Advert', N'<!-- AdSpeed.com Serving Code 7.9 for [Zone] SSCtop 468x60 -->
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (20, 'Total_Scores_Link', N'We keep track of your score to give you bragging rights against your peers. See the <a href="/TotalScores">Total Scores</a> page for breakdowns and comparisons of your points.', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (21, 'Member_Points_Explanation', N'Your point total is calculated as follows:
<blockquote>
<ul>
...
', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (23, 'Newsletter_Archive_Intro', N' ', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (24, 'Registration_Confirmed_Message', N'<p>Welcome to a community of over 900,000 SQL Server enthusiasts! Your registration is now complete, and you have full access to all of our technical articles and to our active forums where even the toughest technical questions are answered within a few hours, or more often minutes.</p>
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (25, 'Account_Created_Message', N'<h3 class="MinMargin">Your account has been created.</h3><p>Before you can receive our regular mailings, <b>you must confirm your registration by clicking the link in the email we have sent you</b>.</p>', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (26, 'Approval_Required_Message', N'<h3 style="margin-top:0px;">Please verify your registration</h3><p>To read the rest of this article, we need you to verify your registration by <b>clicking the link in the email</b> we sent you.</p>', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (27, 'Centre_Column_Feature_Title', N'Featured content', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (28, 'Right_Column_Feature_Title', N'From the SQLServerCentral Blogs', 0)
...
', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (33, 'RSS_Advert_2', N'<!-- Exceptional DBA -->
<table border="0" cellpadding="0" cellspacing="10" width="100%">
 <colgroup>
  <col width="68" />
  <col width="1266" />
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (34, 'RSS_Advert_3', N'<!-- NEW product just released! -->
<table border="0" cellpadding="0" cellspacing="10" width="100%">
 <colgroup>
  <col width="68" />
  <col width="1266" />
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (35, 'RSS_Advert_4', N'<!-- Free “SQL Server Tacklebox” eBook -->
<table border="0" cellpadding="0" cellspacing="10" width="100%">
 <colgroup>
  <col width="68" />
  <col width="1266" />
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (36, 'RSS_Advert_5', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (37, 'RSS_Advert_6', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (38, 'RSS_Advert_7', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (39, 'RSS_Advert_8', N'', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (40, 'Front_Page_Title', N'SQL Server Central. Microsoft SQL Server tutorials, training & forum.', 0)
SET IDENTITY_INSERT [dbo].[StaticTextFragments] OFF
SET IDENTITY_INSERT [dbo].[StaticTextFragments] ON
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (15, 'Homepage_RightColumn_Advert', N'<div align="right">
...
SET IDENTITY_INSERT [dbo].[StaticTextFragments] OFF
SET IDENTITY_INSERT [dbo].[StaticTextFragments] ON
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (6, 'Search_Form_Header', N'<form action="/search/">
...
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (8, 'Meta_Tags', N'<meta name="Keywords" content="Microsoft SQL Server, SQL Server, SQL Server 2000, Yukon, SQL Server 7.0, SQL Server DBA" />
...
', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (10, 'Analytics', N'<!-- Start of Google Analytics Code -->
<script type="text/javascript">
...
', 0)
INSERT INTO [dbo].[StaticTextFragments] ([StaticTextFragmentID], [KeyText], [StaticText], [ContainsTokens]) VALUES (22, 'Skyscraper_Advert', N'<a href="http://www.sqlservercentral.com/Contributions/Home" border="0"><img src="/Resources/Images/Writeforus_M1.gif"></a><br><br>
